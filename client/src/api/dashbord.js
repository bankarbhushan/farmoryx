...
export const getFarmer = async (setFarmers) => {
  try {
...
export const getBills = async (setBills) => {
  try {
    const res = await axios.get(`http://localhost:3000/api/v1/bill/allbills`)
...
export const getFarmerBills = async (setFarmersBills) => {
  try {
    const res = await axios.get(`http://localhost:3000/api/v1/bill/feed?type=farmer`)
...
export const getMerchantBills = async (setMerchantBills) => {
  try {
    const res = await axios.get(`http://localhost:3000/api/v1/bill/feed?type=merchant`)
